			...
			<h1 style="color:white;margin-left:15px;text-shadow:2px 2px 2px white;">DINNER IN THE DARK</h1>			
			   ...
			   <div class="row">
                   <div class="col-sm-12" style="height:40px;width:100%;background:black;">
                                ...
                                <a href="index.php" style="margin-left:20px;text-decoration:none;font-size:20px;">Home</a>
                                <a href="about.php" style="margin-left:20px;text-decoration:none;font-size:20px;">About Us</a>
                                <a href="online.php" style="margin-left:20px;text-decoration:none;font-size:20px;">Online Delivery</a>
					...
					<li><a href="online.php" style="color:white;text-decoration:none;">Online Delivery</a></li>

...
<div class="row">
<div class="col-sm-12">
<h1 style="text-align:center;color:black;text-shadow:2px 2px 2px black;">Change Password</h1>


<form action="#" method="post" >
<span style="color:black">Old Password</span><input type="password" name="opass" class="form-control"/><br/><br/>
<span style="color:black">New Password</span><input type="password" name="npass" class="form-control"/><br/><br/>
<span style="color:black">confirm Password</span><input type="password" name="cpass" class="form-control"/><br/><br/>
